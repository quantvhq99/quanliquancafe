...
namespace GUI {
    ...
    public partial class CoffeeManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class BillDataTable : global::System.Data.TypedTableBase<BillRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BillRow AddBillRow(System.DateTime CheckIn, int TableID, int Discount, int TotalPrice, int Status) {
...
namespace GUI.CoffeeManagementDataSetTableAdapters {
    ...
    public partial class BillTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Bill] WHERE (([ID] = @Original_ID) AND ([CheckIn] = @Original_CheckIn) AND ([TableID] = @Original_TableID) AND ([Discount] = @Original_Discount) AND ((@IsNull_TotalPrice = 1 AND [TotalPrice] IS NULL) OR ([TotalPrice] = @Original_TotalPrice)) AND ([Status] = @Original_Status))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Bill] ([CheckIn], [TableID], [Discount], [TotalPrice], [Status" +
                "]) VALUES (@CheckIn, @TableID, @Discount, @TotalPrice, @Status);\r\nSELECT ID, Che" +
                "ckIn, TableID, Discount, TotalPrice, Status FROM Bill WHERE (ID = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Bill] SET [CheckIn] = @CheckIn, [TableID] = @TableID, [Discount] = @Discount, [TotalPrice] = @TotalPrice, [Status] = @Status WHERE (([ID] = @Original_ID) AND ([CheckIn] = @Original_CheckIn) AND ([TableID] = @Original_TableID) AND ([Discount] = @Original_Discount) AND ((@IsNull_TotalPrice = 1 AND [TotalPrice] IS NULL) OR ([TotalPrice] = @Original_TotalPrice)) AND ([Status] = @Original_Status));
SELECT ID, CheckIn, TableID, Discount, TotalPrice, Status FROM Bill WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.CoffeeManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, CheckIn, TableID, Discount, TotalPrice, Status FROM dbo.Bill";
        ...
        public virtual int Delete(int Original_ID, System.DateTime Original_CheckIn, int Original_TableID, int Original_Discount, global::System.Nullable<int> Original_TotalPrice, int Original_Status) {
        ...
        public virtual int Insert(System.DateTime CheckIn, int TableID, int Discount, global::System.Nullable<int> TotalPrice, int Status) {
        ...
        public virtual int Update(System.DateTime CheckIn, int TableID, int Discount, global::System.Nullable<int> TotalPrice, int Status, int Original_ID, System.DateTime Original_CheckIn, int Original_TableID, int Original_Discount, global::System.Nullable<int> Original_TotalPrice, int Original_Status, int ID) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.DateTime)(Original_CheckIn));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime CheckIn, int TableID, int Discount, global::System.Nullable<int> TotalPrice, int Status, int Original_ID, System.DateTime Original_CheckIn, int Original_TableID, int Original_Discount, global::System.Nullable<int> Original_TotalPrice, int Original_Status) {
            return this.Update(CheckIn, TableID, Discount, TotalPrice, Status, Original_ID, Original_CheckIn, Original_TableID, Original_Discount, Original_TotalPrice, Original_Status, Original_ID);
        }
    }
